            ...
            articles: [
              {
                ...
                description: 'В ситуации с долгами многие автовладельцы задаются вопросом: могут ли судебные приставы забрать их автомобиль? Эта статья поможет разобраться в правах и обязанностях всех участников процесса, а также расскажет о законных способах защиты своего имущества.',
                date: '2023-04-07',
                ...
                content: [
                  ...
                  },
                  {
                    ...
                    description: 'Практические советы по защите имущества от приставов',
                    list: [
                      {
                        icon: 'IconCircle',
                      ...
                      {
                        icon: 'IconCircle',
                        title: 'Альтернативные способы решения проблемы с долгами',
